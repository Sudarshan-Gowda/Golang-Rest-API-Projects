...
func main() {
  db, err = sql.Open("mysql", "root:password@tcp(127.0.0.1:3306)/PRACTICE")
  if err != nil {
    panic(err.Error())
  }
  defer db.Close()
...
func getPosts(w http.ResponseWriter, r *http.Request) {
  ...
  func updatePost(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, "Post with ID = %s updated", params["id"])
  }
  ...
  fmt.Fprintf(w, "Post with ID = %s deleted", params["id"])
  }